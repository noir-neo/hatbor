// NOTICE: This shader is based on the Universal Render Pipeline's UberPost shader.
//
...
Shader "Hidden/Universal Render Pipeline/UberPost"
{
    HLSLINCLUDE
        ...
        half4 FragUberPost(Varyings input) : SV_Target
        {
            ...
            #else
            {
                half4 tmp = SAMPLE_TEXTURE2D_X(_BlitTexture, sampler_LinearClamp, SCREEN_COORD_REMOVE_SCALEBIAS(uvDistorted));
                color = tmp.xyz;
                alpha = tmp.w;
            }
            #endif
